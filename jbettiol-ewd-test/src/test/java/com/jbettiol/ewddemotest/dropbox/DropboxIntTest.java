package com.jbettiol.ewddemotest.dropbox;
...
/**
 * This was all borrowed from:
 * 
 * 	https://github.com/MajewskiKrzysztof/spring-boot-dropbox/tree/master/src/main/java/ninja/majewski/springbootsharepointrest/dropbox
 * 
 * I moved to this solution as I felt my original http proxy-wrapper solution was overkill / stupid
 * 
 * @author john
 *
 */
...
public class DropboxIntTest {
    ...
    public void getFileDetails_shouldReturnFileDetails() {
        ...
        assertThat(fileDetails.getServerModified()).isBefore(new Date(System.currentTimeMillis() + 1000));
    }
